...
<body>
                ...
                <main>
                    <div class="main-sign-container">
                        <div class="sign-wrapper">
                            ...
                            <p id="get-start">to register your fundraising account</p>
                            <form action="./php/complete.php" method="POST" enctype="multipart/form-data">
                                <div class="form-container">
                                    <select class="form-select" id="country" name="country" placeholder="Select your nationality" required>
    ...
    <option value="Zimbabwe">Zimbabwe</option>
                                    ...
                                    <input type="tel" id="phone" name="phone" pattern="\+?\d{9,12}" placeholder="Number as +000000000 (max. 12)" required>
                                    <input type="text" name="org" placeholder="Select your supporting organization" required>
                                    <input type="text" name="iban" placeholder="IBAN" required>
                                    <label for="photo">Attach a profile photo</label>
