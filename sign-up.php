...
<head>
    ...
    <script src="./actions/showTip.js" defer></script>
    <link rel="shortcut icon" href="./favicon/favicon.ico" type="image/x-icon">
    <title>Sign Up with Vidclick</title>
</head>
<body>
                ...
                <main>
                    <div class="already-have">
                        ...
                        <div class="account-have-content">
                            <p>have an account? <a href="./log-in.php">Sign in!</a></p>
                        </div>
                    </div>
                    <div class="main-sign-container">
                        <div class="sign-wrapper">
                            <h1>Get Started With Vidclick</h1>
                            <p id="get-start">Getting started is easy</p>
                            ...
                            <form action="./php/register.php" method="POST">
                                <div class="form-container">
                                    ...
                                    <input type="password" name="password" id="showTip" placeholder="Password" required>
                                    <div class="tip hide">
